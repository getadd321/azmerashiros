...
(() => {
  ...
  const I18N = {
    ...
    "footer.tagline": { en: "Authentic Ethiopian flavors, served fresh every day, in Bole & Hayahulet, Addis.", am: "ትክክለኛ የኢትዮጵያ ጣዕም፣ በየቀኑ ትኩስ ሆኖ በቦሌና በሃያሁለት ይቀርባል።" },
  ...
  const MENU = [
    ...
    { cat: "fasting", price: 598, img: "A6-sunflower-crumble",
      ...
      am: { name: "ሱፍ ፍትፍት", desc: "ከሱፍ የተዘጋጀ።" } },
    ...
    { cat: "nonfasting", price: 848, img: "A51-minchet-abish",
      en: { name: "Minchet (Spiced Minced Beef)" },
      am: { name: "ምንቸት" } },
    ...
    { cat: "nonfasting", price: 3000, img: "A125-agelgil-non-fasting",
